...
#We update our movie view function and call
# the get_reviews class method that takes in a movie
#  ID and will return a list of reviews for that movie.
#  We then pass in the reviews list to our template
#for the function on top



#function thatpasses in a dynamic variable
